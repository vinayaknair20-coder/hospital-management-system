...
class DoctorServices:
    ...
    def create_new_consultation():
        try:
            ...
            # Get appointment details to get specialization_id
            appointment = DoctorServices.dao_services.get_appointment_by_id(appointment_id)
            if not appointment:
                print(f"Appointment id {appointment_id} not found.")
                return
        ...
        try:
            while True:
                ...
                test_pres = Test_prescriptions(
                    prescription_id=prescription_id,
                    test_name=test_name,
                    instructions=None,  # Not stored in database
                )
